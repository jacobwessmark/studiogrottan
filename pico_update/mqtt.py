...
class MQTTClientSetup:
    ...
    def send_heartbeat(self):
        ...
        try:
            self.publish("leddriver/debug", "heartbeat")
    ...
    def reboot(self):
        ...
        self.publish("leddriver/debug", "Rebooting LED driver")
        time.sleep(1)
        machine.reset()
    ...
    def update(self):
        ...
        self.publish("leddriver/debug", "Updating firmware")
